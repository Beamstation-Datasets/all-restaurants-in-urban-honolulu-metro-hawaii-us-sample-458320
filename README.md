# All Restaurants in Urban Honolulu (Metro), Hawaii, US

> Free BeamStation sample export with 276 rows and masked direct-contact fields.
...
| Full dataset size | 2,765 records |
| Free sample size | 276 records (9.98%) |
| Last export | 2026-04-09T14:09:49.068470+00:00 |
| Download | [Latest release asset](https://github.com/Beamstation-Datasets/all-restaurants-in-urban-honolulu-metro-hawaii-us-sample-458320/releases/download/sample-latest/beamstation_458320_restaurants-us-urbanhonoluluhi_SAMPLE_DIST.csv) |
...
Search for dataset ID `458320` on BeamStation if you want the exact commercial listing.
